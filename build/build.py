...
def build(config_file = None, output_file = None, options = None):
    ...
    minimized = file("gxm-license.js").read() + minimized
...
if __name__ == '__main__':
  opt = optparse.OptionParser(usage="%s [options] [config_file] [output_file]\n  Default config_file is 'full.cfg', Default output_file is 'GXM.js'")
  opt.add_option("-c", "--compressor", dest="compressor", help="compression method: one of 'jsmin', 'minimize', 'closure', 'closure_ws', or 'none'", default="closure_ws")
